/*
  # Sync Technicians from HR Records (Fixed)
  
  Populate the technicians table from hr_records where:
  - Employment status is "Employee" (not "Active")
  - Department or job title indicates service/installation work
  
  1. Clear existing technicians (if any)
  2. Insert current employees in service/installation roles
  3. Map Salesforce HR fields to technician fields properly
*/
