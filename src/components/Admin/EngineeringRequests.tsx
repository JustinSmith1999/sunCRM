...
import { Plus, Search, Filter, MoreVertical, CheckSquare, Clock, User, AlertTriangle } from 'lucide-react';
...
export function EngineeringRequests() {
  const [requests] = useState<EngineeringRequest[]>([
    {
      id: '1',
      title: 'Update CRM Dashboard Layout',
      description: 'Modify the main dashboard to show more relevant metrics',
      priority: 'high',
      status: 'in_progress',
    ...
    },
    {
      ...
      description: 'Users need ability to export reports to Excel format',
      priority: 'normal',
      status: 'testing',
  ...
  return (
    <div className="p-3 sm:p-4 lg:p-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-0 mb-4 sm:mb-6">
        <div>
          <h1 className="text-xl sm:text-2xl font-bold text-slate-900">Engineering Requests</h1>
          <p className="text-sm sm:text-base text-slate-600">Track and manage development requests</p>
        </div>
            ...
            <div className="flex items-start justify-between">
              <div className="flex items-start gap-3 sm:gap-4 flex-1">
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-slate-100 rounded-lg flex items-center justify-center flex-shrink-0">
                  <CheckSquare className="w-5 h-5 sm:w-6 sm:h-6 text-slate-600" />
                </div>
